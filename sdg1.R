...
fig_sdg1_income_histogram_poverty <- function(years = c(1990, 2013), region = "WLD") {
  ...
  # Using rio::import to read data from github
  df <- rio::import('https://github.com/alpaziz/alp_sdgatlas2018_demo/blob/master/inputs/sdg1/SDG1_f1_global_dist_histogram.xlsx?raw=true')
